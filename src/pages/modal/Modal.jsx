...
function Modal() {
    ...
    return (
        <div className="modal">
            ...
            <Link to="/categories" className='products-link'>
                <FaArrowLeft />
            ...
            <div className="lunar-vase vasee">
                <div className="lunar-vase-hero">
                    <img src={item.image} alt="The Lunar Vase" className="lunar-vase-img" loading="lazy" />
            ...
            <div className="lunar-vase">
                ...
                <div className="lunar-vase-text">
                    <div className="lunar-vase-text-header">
                        ...
                        <h1>{item.name}</h1>
                        <h3>${item.price} <del>${item.discountPrice}</del></h3>
                    </div>
                    <div className="lunar-vase-text-hero">
                        <p>{item.description}</p>
                        <h3><span>Material</span>{item.material}</h3>
                        <h3><span>Finish</span>{item.finish}</h3>
